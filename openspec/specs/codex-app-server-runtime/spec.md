# codex-app-server-runtime Specification

## Purpose

Defines the isolated, declaratively managed Codex app-server runtime that supplies managed ChatGPT authentication and local rate-limit access to the AI usage exporter.
