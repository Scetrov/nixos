# platform-overview-ai-usage Specification

## Purpose

Defines the freshness-safe Codex allowance and reset information shown on the Operations Platform Overview dashboard.
...
- **WHEN** Codex authentication is unavailable, the source scrape is unsuccessful, the 5-hour window is absent, or the last successful Codex collection is older than two configured source poll intervals
...
- **WHEN** Codex authentication is unavailable, the source scrape is unsuccessful, the 5-hour window or reset timestamp is absent, or the last successful Codex collection is older than two configured source poll intervals
