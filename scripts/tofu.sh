...
export TF_VAR_dtrack_oidc_client_id=$(echo "$SECRETS" | grep dtrack_oidc_client_id | awk '{print $2}')
export TF_VAR_dtrack_oidc_client_secret=$(echo "$SECRETS" | grep dtrack_oidc_client_secret | awk '{print $2}')
